...
import java.io.FileReader;//For Exception Date format
import java.io.FileWriter;//Use Date object
import java.io.IOException; //For Toolkit.getDefaultToolkit().beep();
                ...
                do {
                        ...
                        if (ans == 2) {
                                ...
                                System.out.println(
                                                "                                                 ⁑                                                        ");
                                System.out.println(
                                                "                                                 ⁑          1) Tanishk Jain-   21BEC123               ");
                                System.out.println(
                                                "                                                 ⁑          2) Jay Vadodariya- 21BEC130               ");
                                System.out.println(
                                                "                                                 ⁑          3) Vyom Mistry-    21BEC139               ");
                                System.out.println(
                                                "                                                 ***************************************************     ");
                        }
...
class control extends Flights {
        ...
        void searchForFlight() {
                ...
                do {
                        System.out.println(
                                        "                    ------------------------------------------------------------------------------------------------");
                        System.out.println(
                                        "                    ¦                🔰        Select the Departure city of your journey                                             ");
                        System.out.println("                                       💠      ");


                        String filename1 ="flights1.txt";
                                try (BufferedReader br = new BufferedReader(new FileReader(filename1))) {
                                    String line;
                                    while ((line = br.readLine()) != null) {
                                        System.out.println(line);
                        ...
                        System.out.println(
                                        "                    ------------------------------------------------------------------------------------------------");
                        System.out.println(
                                        "                    ¦                🔰        Select the Destination city of your journey                                             ");
                        System.out.println("                                       💠      ");
                        String filename2 ="flights1.txt";
                                try (BufferedReader br = new BufferedReader(new FileReader(filename2))) {
                                    String line;
                                    while ((line = br.readLine()) != null) {
                                        System.out.println(line);
                        ...
                        int to = sc.nextInt();
                        sc.nextLine();
                        if((from!=to)&&(((from==1)&&(to==2))||((from==2)&&((to==1)||(to==3)))||((from==3)&&(to==2))))
                        {
                               if(from==1&&to==2)
                               {
                                route=1;
                        ...
                        {
                                System.out.println(                            "No Flight available.   PLS Choose Again!!!!!");
                                route=0;
                        }
                    ...
                    do {
                        ...
                        for (int k = 0; k < oc; k++) {
                            if (getPnrNo.equals(Passenger_arr[k].PnrNo)) {
                                ...
                                saveTicketToFile(Passenger_arr[k]);
                                break;
        ...
        void saveTicketToFile(PassengerDetails passenger) {
                try {
                    FileWriter writer = new FileWriter("ticket.txt");
                    writer.write("Ticket Details:\n");
                    writer.write("PNR Number: " + passenger.PnrNo + "\n");
                    writer.write("Name: " + passenger.fullname + "\n");
                    writer.write("Date of Journey: " + passenger.date_of_journey + "\n");
                    String ShowTime = "";
                    ...
                    writer.write("Time of Journey: " + ShowTime + "\n");
                    // Write additional ticket details here
                    writer.close();
                    System.out.println("Ticket saved to ticket.txt");
                } catch (IOException e) {
